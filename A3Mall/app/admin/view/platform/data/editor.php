                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="link-upload-image-box">
                                                    ...
                                                    <img class="layui-upload-img" src="{$item.photo}" style="max-width: 60px; max-height: 60px;" alt="">
                                                </div>
                                            </td>
                                            <td>
        ...
        <tr>
            <td>
                ...
                <div class="link-upload-image-box">
                    ...
                    <img class="layui-upload-img" src="/static/images/not_images.jpg" style="max-width: 60px; max-height: 60px;" alt="">
                </div>
            </td>
            <td>
...
<script type="text/javascript">
        ...
        layui.use(["form", "element",'layer','upload'], function () {
            ...
            uploadfiy($('.layui-table .link-upload-btn'));
