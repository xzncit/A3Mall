                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <table style='width: 100%;' class="layui-table">
                                ...
                                <tbody>
                                <tr>
                                    <td><input type="text" name="point" value="{$data.sell_price|default=intval($data.goods.sell_price)}" required  lay-verify="required" placeholder="请输入积分数量" autocomplete="off" class="layui-input"></td>
    ...
    $(function () {
        ...
        layui.use(["form", "element",'layer','laydate'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('{:createUrl("editor_point")}', data.field, function (result) {
                    layer.close(index);
                    if(result.code){
