...
use mall\library\wechat\mini\payment\Order;
use mall\library\wechat\mini\payment\Refund;
use mall\library\wechat\mini\payment\Bill;
...
class Payment{
    ...
    public function getNotify(){
        return Order::instance()->getNotify();
    }

    public function getNotifySuccessReply(){
        return Order::instance()->getNotifySuccessReply();
    }
