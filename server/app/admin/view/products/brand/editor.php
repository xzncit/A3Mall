<div class="row content-nav">
    <div class="col-xs-12">
        <ul>
            <li><a href="javascript:;"><i></i>&nbsp;品牌管理</a></li>
...
<script type="text/javascript">
    ...
    $(function () {
        layui.use(["form", "element",'layer','upload'], function () {
            ...
            setUEUpload("container",'{:createUrl("common.material/index",["type"=>"image","callback"=>"upload","module"=>"brand","method"=>"image"])}');
            ...
            $("#uploadfiy").on("click",function (){
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1100px', '600px'],
                    content: '{:createUrl("common.material/index",["type"=>"image","callback"=>"photo","module"=>"brand","method"=>"photo"])}'
                });
            });
