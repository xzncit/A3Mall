                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        ...
                        <blockquote class="layui-elem-quote" style="border-left: 5px solid #3c8dbc; font-size: 14px; background-color: #eee;">
                            提示：当前模板属性内容请和微信公众号后台模板消息内容一一对应，【表字段】是当前发送内容的数据表字段名称。如果您不清楚，请勿修改/删除/移动.
                        </blockquote>
                        <div class="layui-form-item">
                            <table class="layui-table">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align:center;">字段/内容</th>
    ...
    $(function () {
        layui.use(["form", "element",'layer'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('{:url("wechat.template/editor")}', data.field, function (result) {
                    layer.close(index);
                    if(result.code){
