                                            ...
                                            <div class="layui-tab-item layui-show">
                                                ...
                                                <div class="layui-form-item">
                                                    ...
                                                    <div class="layui-input-block">
                                                        <input type="text" name="keys" value="{$data.keys|default=''}" lay-reqtext="请填写关键字" lay-verify="required" placeholder="请输入关键字" autocomplete="off" class="layui-input">
                                                    </div>
                                                </div>
    ...
    $(function (){
        ...
        layui.use(["form", "element","layer","upload"], function () {
            ...
            {/if}
                ...
                upload.render({
                    elem: '#upload-images'
                    ,url: '{:url("common.uploadfiy/upload")}'
                    ,multiple: false
