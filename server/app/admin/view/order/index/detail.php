                ...
                <ul class="layui-tab-title">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item" {if $data.shipping_type == 2}style="display:none;"{/if}>
                            ...
                            <div class="layui-form-item" {if $data.shipping_type == 1}style="display:none;"{/if}>
                            <table class="layui-table">
                                <colgroup>
                                    <col width="8%">
                                    <col width="27%">
                                ...
                                <tr>
                                    ...
                                    <td>{$data.store.shop_name|default=""}</td>
                                    <th style="text-align:right;">手机号码：</th>
                                    <td>{$data.store.phone|default=""}</td>
                                </tr>
                                <tr>
                                    <th style="text-align:right;">营业时间：</th>
                                    <td>{$data.store.day_time|default=""}</td>
                                    <th style="text-align:right;">门店地址：</th>
                                    <td>{$data.store.area_name|default=""} {$data.store.address|default=""}</td>
                                </tr>
                                <tr>
                                    <th style="text-align:right;">核销码：</th>
                                    <td colspan="3">{$data.shipping_code|default=""}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
