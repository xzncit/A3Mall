<div class="row content-nav">
    <div class="col-xs-12">
        <ul>
            ...
            <li><a href="javascript:;">退款列表</a></li>
        </ul>
    </div>
</div>
...
<script type="text/html" id="list-toolbar">
    <div style="float: left;">
        <div class="layui-form-pos-btn">
            ...
            <div class="tab-list-btn">申请退款</div>
            <div class="tab-list-btn">退款成功</div>
            <div class="tab-list-btn">拒绝退款</div>
        </div>
    </div>
</script>
...
<script type="text/html" id="list-bar">
    ...
    <a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="order">订单</a>
</script>
...
layui.use(['table','form'], function () {
    ...
    table.render({
        ...
        , cols: [[
                ...
                , {field: 'amount', title: '退款金额',width:120,align:'center'}
                , {field: 'refundment_text', title: '退款状态',width:120,align:'center'}
