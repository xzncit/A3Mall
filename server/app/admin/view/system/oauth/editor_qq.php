                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="config[appkey]" value="{$data.config.appkey|default=''}" lay-reqtext="请填写appkey" lay-verify="required" placeholder="请输入appkey" autocomplete="off" class="layui-input">
                            </div>
                        </div>
