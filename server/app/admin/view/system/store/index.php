<div class="row content-nav">
    <div class="col-xs-12">
        <ul>
            ...
            <li><a href="javascript:;">门店列表</a></li>
        </ul>
    </div>
</div>
    ...
    <div style="background-color: #fff;">
        <form class="layui-form" action="">
            <div class="layui-form-item">
                <label class="layui-form-label" style="text-align: left">开启门店</label>
                <div class="layui-input-block">
                    <input type="checkbox" name="is_shipping" value="1" {if $checked}checked{/if} lay-filter="is_shipping" lay-skin="switch" lay-text="开启|关闭">
                </div>
            </div>
        </form>
    </div>
...
<script>
    layui.use(['table','form'], function () {
        ...
        form.on('switch(is_shipping)', function(data){
            $.post('{:createUrl("index")}',{ checked : data.elem.checked ? 1 : 0 },function (res) {},"json");
        });
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'day_time', title: '营业时间',align: "center",width:220}
