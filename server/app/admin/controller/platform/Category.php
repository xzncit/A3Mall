...
class Category extends Auth {
    ...
    public function index(){
        if(Request::isAjax()) {
            $list = CategoryService::getList(Request::param(),["pid"=>0,"module"=>"article"]);
    ...
    public function editor(){
        try {
            ...
            return View::fetch("",CategoryService::detail(Request::param("id","0","intval"),["status"=>0,"module"=>"article"]));
        }catch (\Exception $ex){
    ...
    public function delete(){
        try{
            CategoryService::deleteArchives(Request::param("id"));
