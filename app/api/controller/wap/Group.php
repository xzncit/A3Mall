...
class Group extends Auth {
    ...
    public function index(){
        ...
        $result = Db::name("promotion_regiment")
            ->alias('r')
            ->field("g.id,r.id as p_id,g.title,g.photo,r.regiment_price as price,r.sell_price,g.sale")
            ->join("goods g","r.goods_id=g.id","LEFT")
            ->where('g.status',0)
    ...
    public function view(){
        ...
        if(($promotion_regiment = Db::name("promotion_regiment")->where("goods_id",$goods["id"])->find()) == false){
        ...
        $goods_item = Db::name("goods_item")
            ->where("id",'in',$promotion_regiment['product_id'])
            ->where(["goods_id"=>$promotion_regiment['goods_id']])->select()->toArray();
        ...
        $data["sku"]["price"] = $promotion_regiment["regiment_price"];
        ...
        $data["goods"] = [
            ...
            "sell_price"=>$promotion_regiment["regiment_price"],
            "market_price"=>$promotion_regiment["sell_price"],
