                                ...
                                <div class="layui-tab-item layui-show">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="mch_id" value="{$data.mch_id|default=''}" lay-reqtext="请填写微信商户编号" lay-verify="required" placeholder="请输入微信商户编号" autocomplete="off" class="layui-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="mch_key" value="{$data.mch_key|default=''}" lay-reqtext="请填写微信商户密钥" lay-verify="required" placeholder="请输入微信商户密钥" autocomplete="off" class="layui-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" value="{:createUrl('api/wechat.pay/',[],false,true)}" readonly="readonly" autocomplete="off" class="layui-input">
                                        </div>
                                    </div>
