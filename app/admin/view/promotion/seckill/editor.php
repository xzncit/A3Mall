        ...
        <form action="" class="layui-form layui-form-pane">
            <div class="layui-tab layui-tab-brief layui-tab-bg layui-tab-content-box">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-input-block">
                            <table style='width: 100%;' class="layui-table">
                                ...
                                <tr>
                                    <td><input type="checkbox" name="product_id[]" value="{$val.id|default=''}" lay-skin="primary" {if $val.checked}checked{/if}></td>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">秒杀属性：</label>
                        <div class="layui-input-block">
                            <table style='width: 100%;' class="layui-table">
                                <colgroup>
                                    <col>
                                ...
                                <tbody>
                                <tr>
                                    <td><input type="text" name="sell_price" value="{$data.sell_price|default=''}" required  lay-verify="required" placeholder="请输入秒杀价格" autocomplete="off" class="layui-input"></td>
                                    ...
                                    <td><input type="text" name="limit_count" value="{$data.limit_count|default=''}" required  lay-verify="required" placeholder="请输入最大购买量" autocomplete="off" class="layui-input"></td>
...
<script type="text/javascript">
    ...
    $(".goods-btn").on("click",function (){
        layer.open({
            ...
            shade: 0.8,
            area: ['80%', '90%'],
            content: '{:url("common.ajax/get_goods")}'
        });
        return false;
    });
    ...
    $(function () {
        ...
        layui.use(["form", "element",'layer','laydate'], function () {
            ...
            laydate.render({
                elem: '#start-time-box',format: 'yyyy-MM-dd HH:mm:ss'
            });
