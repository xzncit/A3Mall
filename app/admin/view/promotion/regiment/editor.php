        ...
        <form action="" class="layui-form layui-form-pane">
            <div class="layui-tab layui-tab-brief layui-tab-bg layui-tab-content-box">
                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">团购属性：</label>
                        <div class="layui-input-block">
                            <table style='width: 100%;' class="layui-table">
                                <colgroup>
                                    <col>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align:center;">最小团购数量</th>
                                    <th style="text-align:center;">最大团购数量</th>
                                    <th style="text-align:center;">排序</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td><input type="text" name="regiment_price" value="{$data.regiment_price|default=''}" required  lay-verify="required" placeholder="请输入团购价格" autocomplete="off" class="layui-input"></td>
                                    ...
                                    <td><input type="text" name="limit_min_count" value="{$data.limit_min_count|default=''}" required  lay-verify="required" placeholder="请输入最小团购数量" autocomplete="off" class="layui-input"></td>
                                    <td><input type="text" name="limit_max_count" value="{$data.limit_max_count|default=''}" required  lay-verify="required" placeholder="请输入最大团购数量" autocomplete="off" class="layui-input"></td>
