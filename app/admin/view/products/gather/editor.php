                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="checkbox" name="goods_extends[]" value="news" title="新品" lay-skin="primary">
                                <input type="checkbox" name="goods_extends[]" value="hot" title="热卖" lay-skin="primary">
                                <input type="checkbox" name="goods_extends[]" value="special" title="特价" lay-skin="primary">
                                <input type="checkbox" name="goods_extends[]" value="recommend" title="推荐" lay-skin="primary">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="radio" name="status" value="0" checked title="上架">
                            ...
                            <div class="layui-upload clearfix">
                                ...
                                <blockquote class="layui-elem-quote layui-quote-nm clearfix" style="margin-top: 10px;">
                                    ...
                                    <div class="layui-upload-list" id="uploadfiy-list-box">
                                        {if !empty($photo)}
                                        {volist name="photo" id="item"}
                                        <div class="uploadfiy-box">
                                            <input type="hidden" name="img[]" value="{$item}">
                                            <a class="upload-image"><img src="{$item}"></a>
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                            <script id="container" style="width:100%;height: 300px;" name="content" type="text/plain">{$data.content|raw|default=""}</script>
                        </div>
