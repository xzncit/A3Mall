<template>
	<view class="wrap">
		<navbar :iSimmersive="false" title-color="#ffffff" background="#1b43c4" :placeholder="true" title="商品评价"></navbar>
		...
		<view v-if="!isError">
			...
			<view class="order">
				<view class="list clear">
					...
					<view class="list-box clear">
						<view>商品评分：</view>
						<view><sx-rate :value="rate" @change="onChange" /></view>
					</view>
					<view class="list-box clear">
						<textarea @blur="bindTextAreaBlur" placeholder="请填写商品评价" maxlength="200"></textarea>
					</view>
				</view>
			</view>

			<view class="btn">
				<view @click="onSubmit">提交</view>
			</view>
		</view>
	</view>
</template>
...
<script>
	...
	import SxRate from '@/components/sx-rate/index'
	import navbar from "@/components/navbar/navbar";
	export default {
		components:{
			MallInfo,SxRate,navbar
		},
		data(){
			return {
				isError: false,
