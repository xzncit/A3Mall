...
<head>
    ...
    <style type="text/css">
        ...
        .copyright { width: 100%; font-size: 16px; color: #fff; text-align: center; position: absolute; left: 0; bottom: 10px; }
...
<body>
    ...
    <div class="copyright">Copyright 2020-<?php echo date("Y"); ?> <a href="http://www.a3-mall.com/" target="_blank">A3MALL</a>. All Rights Reserved.</div>
