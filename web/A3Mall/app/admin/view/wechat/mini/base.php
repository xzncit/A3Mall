                                ...
                                <div class="layui-tab-item layui-show">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="radio" name="mini_status" title="开发版" value="developer" {if empty($data.mini_status) || $data.mini_status=='developer'}checked="checked"{/if}>
                                            <input type="radio" name="mini_status" title="体验版" value="trial" {if isset($data.mini_status) && $data.mini_status=='trial'}checked="checked"{/if}>
                                            <input type="radio" name="mini_status" title="正式版" value="formal" {if isset($data.mini_status) && $data.mini_status=='formal'}checked="checked"{/if}>
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">订阅消息</label>
                                        <div class="layui-input-block">
                                            <input type="radio" name="is_subscribe" title="启用" value="0" {if empty($data.is_subscribe) || $data.is_subscribe==0}checked="checked"{/if}>
                                            <input type="radio" name="is_subscribe" title="关闭" value="1" {if isset($data.is_subscribe) && $data.is_subscribe==1}checked="checked"{/if}>
                                        </div>
                                    </div>
