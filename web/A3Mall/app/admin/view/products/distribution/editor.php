                                        ...
                                        <tr>
                                            <td>
                                                <select name="first_weight" lay-verify="required">
                                                    ...
                                                    <option value="{$key}" {if !empty($data.first_weight) && $data.first_weight == $key}selected{/if} label="{$item}">{$item}</option>
                                                    {/volist}
                                                </select>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <select name="second_weight" lay-verify="required">
                                                    {volist name="weight" id="item"}
                                                    <option value="{$key}" {if !empty($data.second_weight) && $data.second_weight == $key}selected{/if} label="{$item}">{$item}</option>
                                                    {/volist}
                                                </select>
                                            </td>
                                            <td>
