		...
		<view v-if="!isError">
			...
			<view class="order">
				<view class="list clear">
					...
					<view class="list-box clear" v-if="!order.is_refund">
						<textarea @blur="bindTextAreaBlur" placeholder="请填写退款说明" maxlength="200" style="width: 100%; height: 100rpx;"></textarea>
					</view>
					<view class="list-box clear" v-else>
						<view style="width: 100%;">拒绝原因：</view>
						<view style="width: 100%;text-align: left;word-wrap:break-word;line-height: 30rpx;">
							<text>{{order.refund_msg}}</text>
						</view>
					</view>
				</view>
			</view>
