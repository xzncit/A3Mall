<template>
    <view>
		<navbar v-model="screenHeight" title-color="#ffffff" background="#1b43c4" :iSimmersive="false" :placeholder="true" title="商品列表"></navbar>
        <view class="navbar">
        ...
        <view style="height: 100rpx; background-color: #1b43c4"></view>
...
<style lang="scss" scoped>
    .navbar{
        position: fixed;
        top: calc(45px + env(safe-area-inset-top)) + rpx;
        /* #ifdef APP-PLUS */
        left: 0;
        /* #endif */
        /* #ifdef H5 */
