...
class Shake extends BasicWeChat{
    ...
    public function getApplyStatus($applyId){
        $url = "https://api.weixin.qq.com/shakearound/device/applyid?access_token=ACCESS_TOKEN";
        return $this->httpPost($url, ['apply_id' => $applyId]);
    }
    ...
    public function deletePage($page_id){
        ...
        return $this->httpPost($url, ['page_id' => $page_id]);
    }
    ...
    public function upload($filename, $type = 'icon'){
        ...
        return $this->httpPost($url, ['media' => $this->createCurlFile($filename)]);
    }
    ...
    public function totalDeviceList($date, $page_index = 1){
        ...
        return $this->httpPost($url, ['date' => $date, 'page_index' => $page_index]);
    }
    ...
    public function totalPage($page_id, $begin_date, $end_date){
        ...
        return $this->httpPost($url, ['page_id' => $page_id, 'begin_date' => $begin_date, 'end_date' => $end_date]);
    }
    ...
    public function updateGroup($group_id, $group_name){
        ...
        return $this->httpPost($url, ['group_id' => $group_id, 'group_name' => $group_name]);
    }
    ...
    public function deleteGroup($group_id){
        ...
        return $this->httpPost($url, ['group_id' => $group_id]);
    }
    ...
    public function getGroupList($begin = 0, $count = 10){
        ...
        return $this->httpPost($url, ['begin' => $begin, 'count' => $count]);
    }
    ...
    public function getGroupDetail($group_id, $begin = 0, $count = 100){
        ...
        return $this->httpPost($url, ['group_id' => $group_id, 'begin' => $begin, 'count' => $count]);
    }
